...
#
#     PHX_SERVER=true bin/tipping start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :tipping, TippingWeb.Endpoint, server: true
end
...
config :tipping, TippingWeb.Auth.Microsoft,
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/tipping/tipping.db
      """

  config :tipping, Tipping.Repo,
  ...
  config :tipping, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
